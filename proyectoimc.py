...
print("\n")
print("╔" + "═" * 58 + "╗")
print("║" + " " * 10 + "Cálculo de Ïndice de Masa Corporal, (IMC)"+ " " * 7 + "║")
print("╚" + "═" * 58 + "╝")
...
with open("imc.txt", "a") as archivo:
    archivo.write(f"Nombre: {nombre}, Edad: {edad}, estatura: {estatura}, peso: {peso}, IMC: {imc}\n")
